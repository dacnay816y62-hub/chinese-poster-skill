...
LOCAL_MANIFEST = Path("chinese_style_poster_image2_manifest_round2.json")
REMOTE_MANIFEST = OUT_DIR / "manifest-image2-round2.json"
CONTACT = OUT_DIR / "contact-sheet-round2.png"
